...
import com.gmh.dokterlinkv2_1_1.AdapterClasses.ChatsAdapter
import com.gmh.dokterlinkv2_1_1.Fragments.APIService
import com.gmh.dokterlinkv2_1_1.ModelClasses.Chat
import com.gmh.dokterlinkv2_1_1.ModelClasses.Users
import com.gmh.dokterlinkv2_1_1.Notifications.*
...
//    bagian kedua
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        send_message_btn.setOnClickListener {
            ...
            if (message == "")
            {
                Toast.makeText(this@MessageChatActivity, "tolong kirim kan pesan anda dengan benar", Toast.LENGTH_LONG).show()
            }
            else
            {
                        ...
                        .enqueue(object : Callback<MyResponse>
                        {
                            override fun onResponse(
                                ...
                                if (response.code() == 200)
                                {
                                    ...
                                    {
                                        Toast.makeText(this@MessageChatActivity, "Gagal, periksa jaringan anda", Toast.LENGTH_LONG).show()
                                    }
                                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RequestCode && resultCode == RESULT_OK && data!=null && data!!.data!= null)
        {
            ...
            uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                ...
                if (task.isSuccessful)
                {
                    val dwonloadUrl = task.result
                    val url = dwonloadUrl.toString()

                    val messageHashMap = HashMap<String, Any?>()
                    messageHashMap["sender"] = firebaseUser!!.uid
                    messageHashMap["message"] = "kirim gambar"
                            ...
                            if  (task.isSuccessful)
                            {
                                ...
                                reference.addValueEventListener(object : ValueEventListener{
                                    override fun onDataChange(p0: DataSnapshot) {
                                        ...
                                        if (notify)
                                        {
                                            sendNotification(userIdVisit, user!!.getUsername(), "kirim gambar")
                                        }
                                        notify = false
                                    }
